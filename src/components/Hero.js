            ...
            <div className="md:w-[650px] w-[95%] flex flex-col justify-center mx-auto h-screen" >
                <div className="text-center rounded-xl bg-white drop-shadow-3xl">
                    ...
                    <form className="pb-4" onSubmit={handleSubmit}>
                        <div className="py-8 flex sm:flex-row flex-col justify-center">
                            ...
                            <div className="flex justify-center align-middle">
                                <button className="py-2 px-6 ml-0 sm:ml-6 mt-4 sm:mt-0 bg-gray-800 hover:bg-gray-700 font-bold text-white text-xl rounded-xl border-2 border-transparent transition duration-500">Go</button>
                            </div>
                        </div>
                    </form>
                </div>
